...
exports.show_alert = exports.hideAlert = void 0;
var hideAlert = exports.hideAlert = function hideAlert() {
  var el = document.querySelector('.alert');
  if (el) el.parentElement.removeChild(el);
};
var show_alert = exports.show_alert = function show_alert(type, msg) {
...
var stripe = Stripe('pk_test_51PnDpCJiBurjL7tRu1dbsbEFXZjSU4tZoBGFZM63bMba4Bv2maIxVgnU2fk2rnqWoW1i2fL8ee9KV7C7kw2M1fjn00gV0HnqcI');
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 9:
          ...
          (0, _alert.show_alert)('error', _context.t0);
        case 13:
        case "end":
...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoiam9obmphbjc2MiIsImEiOiJjbHpmZG94MXMwenRuMmlzOHhramRjaXNoIn0.UQSeG-PbHlPPze33DeS2ng';
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alert.show_alert)('success', 'Logged In');
        ...
        case 8:
          _context.prev = 8;
          _context.t0 = _context["catch"](0);
          (0, _alert.show_alert)('error', _context.t0.response.data.message);
        case 11:
        case "end":
          return _context.stop();
      }
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          (0, _alert.show_alert)('error', 'Error logging you out');
        case 10:
        case "end":
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"error-page.js":[function(require,module,exports) {
"use strict";
...
var errorFunc = exports.errorFunc = function errorFunc() {
  function drawVisor() {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alert.show_alert)('success', 'Data Updated');
            window.setTimeout(function () {
              location.assign('#');
            }, 1500);
          }
...
var errorPage = document.getElementById('errPage');
...
if (errorPage) (0, _errorPage.errorFunc)();
if (mapBox) {
